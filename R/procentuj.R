...
#' 
#' @param accepts a data.frame column or a vector, whether to include the percent symbol and whether there should be a space between the number and the % symbol
